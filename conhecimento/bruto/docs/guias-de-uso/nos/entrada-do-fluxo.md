...
Define o ponto de entrada de um **sub-fluxo** — um workflow reutilizável que pode ser invocado por outros workflows usando o nó [Chamar Fluxo](https://shift.viasoftcloud.com.br/docs/users/nodes/chamar_fluxo.md). Quando o sub-fluxo é chamado, os parâmetros fornecidos pelo chamador chegam aqui e ficam disponíveis para os nós seguintes.
