...
Pra evitar esse problema, vincule um [Modelo de Entrada](https://shift.viasoftcloud.com.br/docs/users/modelos-entrada) ao nó CSV — ele falha com mensagem clara antes do Mapper.
